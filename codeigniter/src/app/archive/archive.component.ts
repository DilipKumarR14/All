...
export class ArchiveComponent implements OnInit {
    ...
    constructor(private archiveservice: ArchiveService, private cookie: CookieService,
        private common: CommondataService, public dialog: MatDialog, private archivetrash: NoteService, private labelservice: LabelService) {
        this.archiveservice.storeRefresh(this.email).subscribe((status: any) => {
            this.test = status;
        });
    ...
    ngOnInit() {
        ...
        // once the page is reloaded label for the respective card is fetched
    ...
    save() {
        ...
        this.dis = dateformat;
        this.archiveservice.store(this.model, this.email, this.dis, this.color).subscribe(
            (status: any) => {
    ...
    deleteNote(id) {
        ...
        this.archivetrash.deleteNote(id).subscribe(
            (status: any) => {
    ...
    unArchive(id) {
        ...
        this.archiveservice.unarchive(id).subscribe(
            (status: any) => {
